...
def parse(file_path): #coordinates start from the 7th line
    return

if __name__ == "__main__":
    path, poulation_size, elitism, max_generations, crossover_rate, mutation_rate = parse_arguments()
    # cities_coordinates = parse()
