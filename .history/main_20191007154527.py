...
class GeneticAlgorithm():
    def __init__(self, population_size, mat_pool_size, tournament_size, elitism, max_generations, crossover_rate, mutation_rate, cities_list):
    ...
    def selection(self, population):
        ...
        while len(mating_pool) < self.mat_pool_size:
            ...
            fittest = max(participants, key=operator.attrgetter('attrOne'))
...
def main():
    path, population_size, mat_pool_size, tournament_size, elitism, max_generations, crossover_rate, mutation_rate = parse_arguments()
    #delete prints
    print(path)
    ...
    gen_algo = GeneticAlgorithm(population_size, mat_pool_size, tournament_size, elitism, max_generations, crossover_rate, mutation_rate, cities_list)
