...
class GeneticAlgorithm():
    def __init__(self, population_size, elitism, max_generations, crossover_rate, mutation_rate):
...
if __name__ == "__main__":
    ...
    gen_algo = GeneticAlgorithm(population_size, elitism, max_generations, crossover_rate, mutation_rate)
