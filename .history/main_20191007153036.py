...
class GeneticAlgorithm():
    def __init__(self, population_size, mat_pool_size, elitism, max_generations, crossover_rate, mutation_rate, cities_list):
...
def parse_arguments():
    ...
    return args.p, args.s, args.ms, args.e, args.mg, args.cr, args.mr
...
def main():
    path, population_size, mat_pool_size, elitism, max_generations, crossover_rate, mutation_rate = parse_arguments()
    #delete prints
    print(path)
    ...
    gen_algo = GeneticAlgorithm(population_size, mat_pool_size, elitism, max_generations, crossover_rate, mutation_rate, cities_list)
