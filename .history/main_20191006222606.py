...
class GeneticAlgorithm(population_size, elitism, max_generations, crossover_rate, mutation_rate):
...
if __name__ == "__main__":
    ...
    GeneticAlgorithm(population_size, elitism, max_generations, crossover_rate, mutation_rate)
