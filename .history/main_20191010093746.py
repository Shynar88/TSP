...
def write_csv(route):
    with open('solution.csv', mode='w+') as solution:
        writer = csv.writer(solution, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        for city in route:
...
def parse_arguments():
    ...
    parser.add_argument('-s', type=int, default=400, help="population size")
    parser.add_argument('-ms', type=int, default=200, help="mating pool size")
    parser.add_argument('-ts', type=int, default=7, help="tournament size")
    parser.add_argument('-e', type=int, default=70, help="elite_size")
