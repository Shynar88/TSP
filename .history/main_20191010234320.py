...
def parse_arguments():
    ...
    parser.add_argument('-e', type=int, default=17, help="elite_size")
...
def main():
    ...
    gen_algo = GeneticAlgorithm(population_size, population_size/2, tournament_size, elite_size, max_generations, crossover_rate, mutation_rate, cities_list)
