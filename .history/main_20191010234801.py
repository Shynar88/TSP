...
def main():
    ...
    gen_algo = GeneticAlgorithm(population_size, population_size/2, tournament_size, population_size/2, max_generations, crossover_rate, mutation_rate, cities_list)
